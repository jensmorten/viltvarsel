...
For å gjere tala meir intuitive blir frekvensen omrekna til årleg risiko per bil, basert på ein føresetnad om: 15 000 km køyring per år og éin kollisjon ≈ éi melde arbeidsulukke (illustrativt). Denne årsrisikoen blir samanlikna med melde arbeidsulukker per årsverk i ulike yrke (SSB), og brukt som ei pedagogisk skala, ikkje ei presis risikovurdering.
